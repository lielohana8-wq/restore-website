...
const D = {
  ...
  areas: "ירושלים · בית שמש · מעלה אדומים · מבשרת ציון · גבעת זאב · ביתר עילית · אפרת · גוש עציון · מודיעין עילית · מודיעין · מישור אדומים · פזגת זאב · רמות · הר נוף · קריית מנחם · תלפיות · עיר דוד · גילה · ארנונה · בקעה",
};
...
["לאן מגיעים?","אזור ירושלים והסביבה — ירושלים, בית שמש, מעלה אדומים, מבשרת ציון, גבעת זאב, ביתר עילית, מודיעין עילית, מודיעין ועוד. הגעה חינם ברוב האזורים."],
...
function LiveNotif(){
  ...
  const msgs=[
    ...
    "יוסי ממעלה אדומים הזמין ניקוי מזגן ❄️",
    "משפחת כהן מבית שמש — ניקוי 3 מזרנים 🛏️",
    "רונית ממבשרת ציון הזמינה ניקוי רכב 🚗",
    "עמית מגבעת זאב — 6 כיסאות + ספה 🪑",
    "משפחת לוי ממודיעין — ניקוי מזגן מרכזי 🌬️",
  ];
  useEffect(()=>{
    const t1=setTimeout(()=>{
