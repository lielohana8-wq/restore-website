...
{/* ══════ PROBLEM → SOLUTION ══════ */}
<section className="sec" style={{position:"relative",overflow:"hidden",backgroundImage:"linear-gradient(rgba(9,9,9,.9),rgba(9,9,9,.9)),url(/img/lion-ac.png)",backgroundSize:"cover",backgroundPosition:"center"}}>
