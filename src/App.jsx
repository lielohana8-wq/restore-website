...
["כמה זמן לוקח ניקוי ספה?","הניקוי עצמו אורך 30-60 דקות, תלוי בגודל הספה ורמת הלכלוך. זמן ייבוש: 4-6 שעות. ספות עור מתייבשות מהר יותר. מומלץ לאוורר את החדר."],
["האם החומרים בטוחים לילדים ולחיות?","כן, חומרים היפואלרגניים בלבד — ללא כלור וללא אמוניה. בטוחים לתינוקות, ילדים, בעלי חיים ואנשים רגישים. אחרי הניקוי נשאר רק ריח נעים ורענן."],
["אתם מנקים כל סוגי הספות?","כן — בד, עור, דמוי עור, אימפלה, קטיפה, מיקרופייבר, אלקנטרה ועוד. לכל סוג בד יש שיטת ניקוי מותאמת. שלחו תמונה ונאבחן בחינם."],
["כמה עולה ניקוי ספה?","ניקוי ספה מתחיל מ-₪"+(D.services?.[0]?.price||250)+" כולל חיטוי ובישום. המחיר תלוי בגודל, סוג הבד ומצב הכתמים. שלחו תמונה בוואטסאפ — הצעה מדויקת תוך דקות, בלי התחייבות."],
["מה אם הכתם לא יורד?","95% מהכתמים יורדים בטיפול הראשון. לגבי כתמים עקשנים במיוחד — נעדכן אתכם מראש לגבי הסיכויים. לא מבטיחים מה שלא נוכל לספק, ותמיד נציע פתרון."],
["לאן אתם מגיעים?","פריסה ארצית — גוש דן, שרון, שפלה, ירושלים, חיפה, באר שבע, אשדוד, אשקלון, מודיעין ועוד. הגעה חינם ברוב האזורים. שלחו כתובת ונאשר."],
["אתם מביאים את כל הציוד?","כן, מגיעים עם הכל — מכונת שאיבה תעשייתית, חומרי ניקוי וחיטוי, מברשות וציוד בישום. לא צריך להכין כלום, רק לפנות גישה לספה ושקע חשמל."],
["מתי אפשר לשבת על הספה?","אחרי 4-6 שעות ייבוש. אחרי הייבוש — הספה מוכנה לשימוש מיידי עם ריח רענן ובד שמרגיש כמו חדש. כדאי לאוורר ולא להניח כריות רטובות עד אז."],
["גם מזרנים, שטיחים ורכבים?","כן! מזרנים מ-₪"+(D.services?.[1]?.price||150)+", שטיחים מ-₪"+(D.services?.[4]?.price||200)+", כיסאות מ-₪"+(D.services?.[5]?.price||80)+", פנים רכבים מ-₪"+(D.services?.[3]?.price||300)+", מזגנים מ-₪"+(D.services?.[2]?.price||150)+". הנחות חבילה למזמינים כמה שירותים."],
["יש אחריות?","אחריות מלאה על כל עבודה. אם לא מרוצים — נחזור ונתקן בחינם. עובדים בשקיפות: מסבירים מראש מה צפוי ולא גובים על שירות שלא סופק."],
["איך מזמינים?","שולחים תמונה בוואטסאפ → מקבלים הצעה תוך דקות → מתאמים מועד (7 ימים בשבוע). מגיעים, מנקים, ומשאירים הכל כמו חדש. תשלום במזומן, ביט, אפליקציה או אשראי."]
